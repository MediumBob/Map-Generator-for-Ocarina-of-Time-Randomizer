...
// tests for AdjustNodeNames (23 total)
describe('Parser.AdjustNodeNames', () => {
  ...
  test('should log "no adjustments" for any other input', () => {
    jest.spyOn(console, 'log');
    Parser.AdjustNodeNames('Any Other Input');
    expect(console.log).toHaveBeenCalledWith('no adjustments');
  });
});
